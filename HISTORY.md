...
* Upgraded to netty 3.5.3. The most recent API compatible Netty version is 3.6.5, but it has [memory leaks](https://github.com/netty/netty/issues/1301) (Aslak Hellesøy)
